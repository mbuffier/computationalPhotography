function r = mainHomography(jsonFileName, imageFolder, numberOfFrame)
...
for i = 1:numberOfFrame
    ...
    % fill in the result 
    R = imref2d([M N]) ;
    newImage = imwarp(thisImage,tform, 'OutputView', R) ;
